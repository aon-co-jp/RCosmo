...
open-cosmo règle ce problème à la racine grâce à **GraphQL Federation + VersionlessAPI**.
...
| Fonctionnalité | Cosmo gratuit | Cosmo payant | **open-cosmo** |
|---|:---:|:---:|:---:|
...
### Fonctionnalités exclusives à open-cosmo
...
## Structure du workspace (18 crates)
