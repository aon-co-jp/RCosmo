...
cd open-cosmo
cargo test --workspace          # 테스트 343개(--all-features 시 362개)
...
데이터 손실을 방지하는 것이 목적이다. open-cosmo는 그 안에서 Federation
